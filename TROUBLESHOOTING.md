...
- [Projects](#projects)
  ...
  - [Update the project folder to a Labs shared folder](#update-the-project-folder-to-a-labs-shared-folder)
...
### Update the project folder to a Labs shared folder
- **Symptoms**: The user wants new downloads to land inside a Labs-managed shared folder instead of their default `~/loop_downloads` project workspace.
...
- **Escalation**: If the Labs shared folder cannot be selected, confirm the user has write permissions through the Open OnDemand Files application or involve the HPC storage team to adjust ACLs.
